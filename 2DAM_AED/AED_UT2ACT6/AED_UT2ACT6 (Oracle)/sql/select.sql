...
SELECT pv.nombre_prov, COUNT(pd.cod_prod) count_prod, AVG(pd.precio) avg_precio FROM proveedores pv, productos pd WHERE pv.cod_prov = pd.cod_prov GROUP BY pv.nombre_prov
